...
function Contact() {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText("adeziio@yahoo.com");
    setShowTooltip(true);
    setTimeout(() => {
